<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RPT_Product_Specialists.aspx.vb" Inherits="APT.RPT_Product_Specialists"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
  <HEAD>
		<title>Product Specialists</title>
        ...
        <TR vAlign=top>
          ...
          <TD>
			<table width="100000" id="TabReport" runat="server" height=75>
				<tr>
					<td>
						<span class="TitreRapport">Product Specialists</span>
						<br ><br >
