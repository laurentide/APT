<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RPT_Initiative_Summary.aspx.vb" Inherits="APT.RPT_Initiative_Summary"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
  <HEAD>
		<title>Initiative Summary</title>
        ...
        <TR vAlign=top>
          ...
          <TD>
			<table width="100000" id="TabReport" runat="server" height=75>
				<tr>
					<td>
						<span class="TitreRapport">Initiative Summary</span>
						<br ><br >
