...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents Status As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Session("OS") = Nothing And Not User.IsInRole("LCLMTL\LCL_Apt") _
           And Not User.IsInRole("LCLMTL\LCL_AE") And Not User.IsInRole("LCLMTL\LCL_SA") Then
        ...
        Else
            ...
            Dim CBStatus As ComboBox = FindControl("WFollowUp")
            Dim CBGRouping As ComboBox = FindControl("WFollowUp")
    ...
    Sub SendSearch(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Status.Text = "" And ModelNumber.Text = "" And NetPrice.Text = "" And OsNo.Text = "" _
        ...
        If valide = True Then
            ...
            If OsNo.SelectedValue = "" Then
                strComm += "&OsNo="
            ElseIf OsNo.SelectedValue < 100 And (Session("OS") = Nothing) Then
