<%@ Page Language="vb" AutoEventWireup="false" Codebehind="RPT_Bookings_Results.aspx.vb" Inherits="APT.Bookings_Results"  %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
  <HEAD>
		<title>Bookings Results</title>
        ...
        <TR vAlign=top>
          ...
          <TD>
									<table width="100000" id="TabReport" runat="server" height="75">
										<tr>
											<td>
												<span class="TitreRapport">
												Forecasts, Bookings, Quotes -
